        ...
        <ul class = "list-group" style="list-style: none; padding: 0px; margin: 0px;">
            ...
            @if(count($courses) <= 0)
                    <div class="row" style="margin-top: 20%;">
                        <p style="text-align: center; margin-left: 30%;">There is no course already enrolled yet <br>
                            <small>Click here to view the course <a href="/student/explore" target="_blank" rel="noopener noreferrer">Explore Courses</a></small>
                        </p>
